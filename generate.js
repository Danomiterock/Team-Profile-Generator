...
<nav class="navbar navbar-dark bg-primary" style="color:white; font-size:50px; text-align:center;">Team Profile Generator</nav>
<body>
...
function renderEmployee(employee) {
  ...
  <div class="card-body">
    ...
    <h2 class="employee-name mb-2 text-white">"${employee.getRole()}'s name: " ${
		employee.name
	}</h2>
